                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Babysitter name or Email or Date (YYYY-MM-DD)" list="doctors" >&nbsp;&nbsp;
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Babysitter name:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Babysitter Email:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Session Starts : '.$scheduletime.'am to 5:30:00pm<br>
                                                            Channeling fee : <b>ksh.300.00</b>
